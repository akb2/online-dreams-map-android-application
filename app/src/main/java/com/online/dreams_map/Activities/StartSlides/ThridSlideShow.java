...
public class ThridSlideShow extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.slide3_activity);
    ...
    OnClickListener goToNextSlide = new OnClickListener() {
        @Override
        public void onClick(View v){
            Intent intent=new Intent(getApplicationContext(), FourthSlideShow.class);
            startActivity(intent);
